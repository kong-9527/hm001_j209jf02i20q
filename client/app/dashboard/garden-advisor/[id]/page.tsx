...
import { getGardenAdvisorDetail } from '@/app/services/gardenAdvisorService';
import type { GardenAdvisorDetail as GardenAdvisorDetailType } from '@/app/services/gardenAdvisorService';
                ...
                <div className="grid grid-cols-3 md:grid-cols-6 gap-4 mt-2 text-sm">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <div className="flex items-center mt-1">
                      <div className={`bg-${
                        space.cultivation.includes('Round') ? '[#F9E9FB]' : 
                        space.cultivation.includes('Square') ? '[#E6F7FF]' : 
                        space.cultivation.includes('Raised') ? '[#EDFAEF]' : 
                        '[#FFF3E0]'
                  ...
                  {space.plants.map((plant, plantIndex) => (
                    ...
                    >
                      <div className={`font-medium flex items-center ${
                        selectedPlant === plant.name ? 'text-white' : 'text-primary'
                      }`}>
