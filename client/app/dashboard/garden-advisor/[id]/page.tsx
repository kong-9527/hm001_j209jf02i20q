              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {["Lavender", "Butterfly Bush", "Black-Eyed Susan", "Coneflower"].map((plant, index) => (
                  ...
                  >
                    ...
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 384 512" class="mr-1 inline-block" data-sentry-element="FaTree" data-sentry-source-file="GardenRecommendation.tsx" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
