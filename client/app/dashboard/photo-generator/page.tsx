      ...
      <div className="mt-4">
        ...
        <div className="flex justify-between mt-3 mb-3">
          <div className="flex gap-2">
            <button className="flex items-center px-3 py-1.5 border border-gray-300 rounded-lg text-sm">
            ...
            <button className="flex items-center px-3 py-1.5 bg-emerald-600 text-white rounded-lg text-sm hover:bg-emerald-700">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1.5">
